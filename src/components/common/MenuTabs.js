      ...
      <div className="flex rounded-[16px] bg-primary-light dark:bg-primary-dark w-fit transition-all duration-200">
        {[0, 0, 0, 0, 0].map((_, index) => (
          ...
          >
            <FaHome
              size={18}
              className={`absolute ${active === index ? "top-0 text-background-dark dark:text-background-light" : "top-1/2"}  left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 transition-all delay-200 duration-200`}
            />
            <p
